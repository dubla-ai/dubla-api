...
export class InitialMigration1722811070894 implements MigrationInterface {
  name = 'InitialMigration1722811070894';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "projects" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "name" character varying NOT NULL, "providerId" character varying NOT NULL, "description" character varying, "userId" uuid, CONSTRAINT "PK_6271df0a7aed1d6c0691ce6ac50" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "paragraphs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "name" character varying NOT NULL, "text" character varying NOT NULL, "voiceId" uuid, "projectId" uuid, CONSTRAINT "PK_31041595073b54a7816865eba74" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "audios" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "providerId" character varying(255), "storageProviderKey" character varying(255), "storageFileUrl" character varying(255), "paragraphId" uuid, "voiceId" uuid, CONSTRAINT "PK_97a1fa83e0d0dac358d498d0a64" PRIMARY KEY ("id")); COMMENT ON COLUMN "audios"."providerId" IS 'Resemble internal ID'; COMMENT ON COLUMN "audios"."storageProviderKey" IS 'S3 bucket key'`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "paragraphs" ADD CONSTRAINT "FK_1c14848a0fbc75132ac24c4c212" FOREIGN KEY ("projectId") REFERENCES "projects"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "audios" ADD CONSTRAINT "FK_b32d08bf9fa875597af39a95adc" FOREIGN KEY ("voiceId") REFERENCES "voices"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "audios" DROP CONSTRAINT "FK_b32d08bf9fa875597af39a95adc"`,
    );
    await queryRunner.query(
      `ALTER TABLE "audios" DROP CONSTRAINT "FK_0ce29b4f0a7495597c63ef075eb"`,
    );
    await queryRunner.query(
      `ALTER TABLE "paragraphs" DROP CONSTRAINT "FK_1c14848a0fbc75132ac24c4c212"`,
    );
    await queryRunner.query(
